...
import gap.jac.tools.StandardJavaFileManager;
import gap.jac.tools.JavaFileObject;
import gap.jac.tools.DiagnosticListener;

import gap.jac.source.util.TaskEvent;
import gap.jac.source.util.TaskListener;
import gap.jac.api.JavacTaskImpl;
import gap.jac.code.*;
import gap.jac.code.Symbol.*;
import gap.jac.file.Paths;
import gap.jac.file.JavacFileManager;
import gap.jac.jvm.*;
import gap.jac.JavaCompiler;
import gap.jac.model.JavacElements;
import gap.jac.model.JavacTypes;
import gap.jac.parser.*;
import gap.jac.tree.*;
import gap.jac.tree.JCTree.*;
import gap.jac.util.Abort;
import gap.jac.util.Context;
import gap.jac.util.List;
import gap.jac.util.ListBuffer;
import gap.jac.util.Log;
import gap.jac.util.Name;
import gap.jac.util.Options;

import static gap.jac.tools.StandardLocation.*;
