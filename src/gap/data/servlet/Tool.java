 ...
 */
@Generated(value={"gap.service.OD","odl/bean-servlet.xtm"},date="2009-10-11T13:24:02.557Z",comments="gap.data")
public class Tool
    ...
    protected TemplateDictionary doGetDefine(Request req, Response rep){
        ...
        if (this.canRead(req)){
            ...
            if (req.hasPath(1) && req.hasPath(3)){
                ...
                gap.data.Tool instance = gap.data.Tool.ForLongId(parentKey,req.getPath(1));
