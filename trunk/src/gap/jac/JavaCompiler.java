...
import gap.jac.processing.*;
import gap.jac.annotation.processing.Processor;

import static gap.jac.tools.StandardLocation.CLASS_OUTPUT;
import static gap.jac.util.ListBuffer.lb;

// TEMP, until we have a more efficient way to save doc comment info
import gap.jac.parser.DocCommentScanner;
...
//      System.err.println("completing " + c);//DEBUG
   ...
   public List<JCCompilationUnit> parseFiles(List<JavaFileObject> fileObjects) throws IOException {
    ...
    public static void enableLogging() {
        Logger logger = Logger.getLogger(gap.jac.Main.class.getPackage().getName());
