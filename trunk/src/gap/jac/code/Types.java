...
import gap.jac.jvm.ClassReader;
import gap.jac.comp.Infer;
import gap.jac.comp.Check;

import static gap.jac.code.Type.*;
import static gap.jac.code.TypeTags.*;
import static gap.jac.code.Symbol.*;
import static gap.jac.code.Flags.*;
import static gap.jac.code.BoundKind.*;
