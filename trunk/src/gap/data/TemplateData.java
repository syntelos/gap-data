 ...
 * Generated data bean
 */
@Generated(value={"gap.service.OD","BeanData.java"},date="2010-02-06T00:27:41.207Z")
               ...
               HasName
{
    ...
    public final static Kind KIND = Kind.Create("Template","gap.data","Template","/templates");
    ...
    protected TemplateData(Key ancestor, String name) {
        super();
        this.setName(name);
