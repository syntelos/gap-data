 ...
 *
 */
public class OrderCommandsImpl 
    extends Object
    implements OrderCommands
{
    ...
    @Override
    public OrderStateChangeNotification cancelOrder(String reason)
    ...
    @Override
    public RefundAmountNotification refundOrder(String reason)
        throws CheckoutException
    {
    ...
    @Override
    public RefundAmountNotification refundOrder(String reason, double refundAmount)
        throws CheckoutException
    {
    ...
    @Override
    public RefundAmountNotification refundOrder(String reason, BigDecimal refundAmount)
        throws CheckoutException
    {
        RefundOrderRequest refundOrderRequest = new RefundOrderRequest();
        refundOrderRequest.setGoogleOrderNumber(googleOrderNumber);
    ...
    @Override
    public ItemCommands itemCommands(List<String> itemIds)
        throws CheckoutException
    {
    ...
    @Override
    public ItemCommands itemCommands(String... itemIds)
        throws CheckoutException
    {
        List<ItemId> copyIds = new ArrayList<ItemId>();
        for (String s : itemIds) {
    ...
    @Override
    public ItemCommands itemCommands(ItemId... itemIds)
        throws CheckoutException
    {
        List<ItemId> copyIds = new ArrayList<ItemId>();
    ...
    @Override
    public ChargeAmountNotification chargeAndShipOrder(double amount)
        throws CheckoutException
    {
        return chargeAndShipOrder(BigDecimal.valueOf(amount), (TrackingDataBuilder)null);
    }

    @Override
    public ChargeAmountNotification chargeAndShipOrder(BigDecimal bigDecimal)
        throws CheckoutException
    {
    ...
    @Override
    public ChargeAmountNotification chargeAndShipOrder(TrackingDataBuilder shipping)
        throws CheckoutException
    {
    ...
    @Override
    public ChargeAmountNotification chargeAndShipOrder(double amount, TrackingDataBuilder shipping)
        throws CheckoutException
    {
    ...
    @Override
    public ChargeAmountNotification chargeAndShipOrder(BigDecimal bigDecimal, TrackingDataBuilder shipping)
        throws CheckoutException
    {
    ...
    @Override
    public ChargeAmountNotification chargeAndShipOrder(ItemShippingInformationBuilder shipping)
        throws CheckoutException
    {
        return chargeAndShipOrder(null, shipping);
    }
    ...
    @Override
    public ChargeAmountNotification chargeAndShipOrder(double amount, ItemShippingInformationBuilder shipping)
        throws CheckoutException
    {
        return chargeAndShipOrder(BigDecimal.valueOf(amount), shipping);
    }
    ...
    @Override
    public ChargeAmountNotification chargeAndShipOrder(BigDecimal amount, ItemShippingInformationBuilder shipping)
        throws CheckoutException
    {
        return chargeAndShipOrder(amount, shipping, null);
    }

    private ChargeAmountNotification chargeAndShipOrder(BigDecimal amount, 
                                                        ItemShippingInformationBuilder itemShipping, 
                                                        TrackingDataBuilder orderShipping)
        throws CheckoutException
    {
    ...
    public OrderSummary getOrderSummary() {
        return (apiContext.reportsRequester().
                requestOrderSummaries(Collections.singletonList(googleOrderNumber)).get(0));
    }
    ...
    class ItemCommandsImpl implements ItemCommands {
        ...
        @Override
        public void cancelItems(String reason)
            throws CheckoutException
        {
    ...
    protected RequestReceivedResponse postCommand(JAXBElement<?> command) {
        ...
        return (RequestReceivedResponse) apiContext.postCommand(CommandType.ORDER_PROCESSING, command);
    }
}
