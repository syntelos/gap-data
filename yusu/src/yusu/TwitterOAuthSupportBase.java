...
import yusu.http.*;
import yusu.client.HttpClient;
import yusu.client.HttpClientWrapper;
import yusu.client.HttpResponse;
import yusu.client.HttpResponseEvent;

import java.io.IOException;
import java.io.ObjectInputStream;

/**
 * Code layer under {@link Twitter}
 * 
 * @author Yusuke
 */
abstract class TwitterOAuthSupportBase
    extends TwitterBase
    implements yusu.client.HttpResponseListener, 
               yusu.http.OAuthSupport, 
               java.io.Serializable
{
    ...
    protected TwitterOAuthSupportBase(Configuration conf) {
        super(conf);
        init();
    }
    protected TwitterOAuthSupportBase(Configuration conf, String screenName, String password) {
        super(conf, screenName, password);
        init();
    }
    protected TwitterOAuthSupportBase(Configuration conf, Authorization auth) {
        super(conf, auth);
        init();
    }
