...
import gap.jac.code.Source;
import gap.jac.file.JavacFileManager;
import gap.jac.jvm.Target;
import gap.jac.JavacOption.Option;
import gap.jac.RecognizedOptions.OptionHelper;
import gap.jac.util.*;
import gap.jac.processing.AnnotationProcessingError;
...
public class Main {
    ...
    public static void main(String[] argv){
        Main main = new Main("gap.jac");
        int rc = main.compile(argv);
        System.exit(rc);
    }
    public static int main(String[] argv, PrintWriter err){
        Main main = new Main("gap.jac",err);
        return main.compile(argv);
    }
                       ...
                       Iterable<? extends Processor> processors)
    {
        ...
        try {
            ...
            // as specified by gap.jac.tools.JavaCompiler#getTask
            // and gap.jac.tools.JavaCompiler.CompilationTask#call
