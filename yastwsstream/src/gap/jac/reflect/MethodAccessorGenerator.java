...
/** Generator for gap.jac.reflect.MethodAccessor and
    gap.jac.reflect.ConstructorAccessor objects using bytecodes to
...
class MethodAccessorGenerator extends AccessorGenerator {
                                       ...
                                       Class serializationTargetClass)
    {
        ...
        //     [UTF-8] "gap/jac/reflect/{MethodAccessorImpl,ConstructorAccessorImpl,SerializationConstructorAccessorImpl}"
        //     [CONSTANT_Class_info] for above
        ...
        if (isConstructor) {
            if (forSerialization) {
                asm.emitConstantPoolUTF8
                    ("gap/jac/reflect/SerializationConstructorAccessorImpl");
            } else {
                asm.emitConstantPoolUTF8("gap/jac/reflect/ConstructorAccessorImpl");
            }
        } else {
            asm.emitConstantPoolUTF8("gap/jac/reflect/MethodAccessorImpl");
        }
        asm.emitConstantPoolClass(asm.cpi());
        superClass = asm.cpi();
                                                    ...
                                                    boolean forSerialization)
    {
        if (isConstructor) {
            if (forSerialization) {
                ...
                return "gap/jac/reflect/GeneratedSerializationConstructorAccessor" + num;
            } else {
                int num = ++constructorSymnum;
                return "gap/jac/reflect/GeneratedConstructorAccessor" + num;
            }
        } else {
            int num = ++methodSymnum;
            return "gap/jac/reflect/GeneratedMethodAccessor" + num;
        }
    }
}
