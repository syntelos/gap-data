...
public interface JavaFileManager extends Closeable, Flushable, OptionChecker {
     ...
     * "gap.jac" in the {@linkplain
     * StandardLocation#SOURCE_PATH SOURCE_PATH} location, this method
     * might be called like so:
     *
     * <pre>getFileForInput(SOURCE_PATH, "gap.jac", "resources/compiler.properties");</pre>
     *
     ...
     * <code>"C:\Documents&nbsp;and&nbsp;Settings\UncleBob\src\share\classes\gap.jac\resources\compiler.properties"</code>.
     *
     * @param location a location
     * @param packageName a package name
