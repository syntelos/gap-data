 ...
 * gap.jac.annotation.processing.RoundEnvironment rounds}.  On each
 ...
 * controlled.  For example, for a {@link gap.jac.tools.JavaCompiler
 * JavaCompiler} the list of candidate processors to run can be
 * {@linkplain gap.jac.tools.JavaCompiler.CompilationTask#setProcessors
 * set directly} or controlled by a {@linkplain
 * gap.jac.tools.StandardLocation#ANNOTATION_PROCESSOR_PATH search path}
...
public interface Processor {
     ...
     * @see gap.jac.annotation.processing.SupportedOptions
     */
     ...
     * @see gap.jac.annotation.processing.SupportedAnnotationTypes
     ...
     * processor.
     * @see gap.jac.annotation.processing.SupportedSourceVersion
    ...
    * <blockquote>
    * <pre>
    * import static gap.jac.annotation.processing.Completions.*;
    * ...
