 ...
 * @see Target
 */
@Generated(value={"gap.service.OD","BeanData.java"},date="2010-03-06T09:33:50.547Z")
    ...
    implements DataInheritance<Target>
{
    ...
    public final static Kind KIND = Kind.Create("Target","yas.data","Target","/target");

    public final static String ClassName = "Target";

    public final static String DefaultSortBy = "twitterId";


    public final static gap.service.od.ClassDescriptor ClassDescriptorFor(){
        return ClassDescriptorFor(Target.class);
    }
    ...
    public final static Target ForLongTwitterId(String twitterId){
        if (null != twitterId){
            Key key = KeyLongIdFor( twitterId);
            Target instance = (Target)gap.data.Store.Get(key);
            if (null != instance)
                return instance;
            else {
                Query q = CreateQueryFor(key);
                return (Target)gap.data.Store.Query1(q);
            }
        }
        else
            throw new IllegalArgumentException();
    ...
    public final static Target GetCreateLong(String twitterId){
        Target target = ForLongTwitterId( twitterId);
        if (null == target){
            target = new Target( twitterId);
            target = (Target)gap.data.Store.Put(target);
        }
        return target;
    }
    ...
    public final static Target ForLongId(String id){
        if (null != id){
    ...
    public final static Target Get(Key key){
        if (null != key){
            Target instance = (Target)gap.data.Store.Get(key);
            if (null != instance)
                return instance;
    ...
    public final static Target FromObject(Object value){
        if (null == value)
            return null;
     ...
     * memcache and store.
     */
    public final static void Delete(Target instance){
        if (null != instance){
     ...
     */
    public final static void Clean(Target instance){
        if (null != instance){
            Key key = instance.getKey();
     ...
     * Store the instance.
     */
    public final static void Save(Target instance){
        if (null != instance){
     ...
     */
    public final static void Store(Target instance){
        if (null != instance){
            gap.data.Store.Put(instance);
        }
    }
    ...
    public final static Target Query1(Query query){
        if (null != query)
            return (Target)gap.data.Store.Query1(query);
        else
            throw new IllegalArgumentException();
    }
    ...
    /**
     * Persistent fields' binding for {@link Target}
     */
        ...
        implements gap.data.Field<Field>
    {
        ...
        public static Object Get(Field field, Target instance, boolean mayInherit){
            switch(field){
            case InheritFromKey:
        ...
        public static boolean Set(Field field, Target instance, Object value){
            switch(field){
            case InheritFromKey:
    ...
    private volatile transient Target inheritFrom;
    ...
    protected TargetData(String twitterId) {
        super();
    ...
    public final Target getInheritFrom(){
        Target inheritFrom = this.inheritFrom;
        if (null == inheritFrom){
            Key inheritFromKey = this.inheritFromKey;
            if (null != inheritFromKey){
                inheritFrom = Target.Get(inheritFromKey);
                this.inheritFrom = inheritFrom;
            }
        }
        return inheritFrom;
    }
    public final boolean setInheritFrom(Target ancestor){
    ...
    public final boolean inheritFrom(Target ancestor){
        if (IsNotEqual(this.inheritFrom,ancestor)){
            this.inheritFrom = ancestor;
            if (null != ancestor)
                this.inheritFromKey = ancestor.getKey();
    ...
    public final boolean updateFrom(BigTable proto){
        return this.updateFrom( (Target)proto);
    }
    ...
    public void setVariable(TemplateName name, String value){
        ...
        if (null != field){
            if (name.has(1)){
                ...
                Field.Set(field,((Target)this),value);
        }
        else {
