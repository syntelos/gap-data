 ...
 * @see Retweet
 */
@Generated(value={"gap.service.OD","BeanData.java"},date="2010-03-25T08:40:04.275Z")
    ...
    implements DataInheritance<Retweet>
{
    ...
    public final static Kind KIND = Kind.Create("Retweet","yas.data","Retweet","/retweet");

    public final static String ClassName = "Retweet";

    public final static String DefaultSortBy = "";


    public final static gap.service.od.ClassDescriptor ClassDescriptorFor(){
        return ClassDescriptorFor(Retweet.class);
    }
    ...
    public final static Retweet ForLongId(String id){
        if (null != id){
            Key key = KeyLongFor(id);
            Retweet instance = (Retweet)gap.data.Store.Get(key);
            if (null != instance)
                return instance;
            else {
                Query q = CreateQueryFor(key);
                return (Retweet)gap.data.Store.Query1(q);
            }
        }
        else
    ...
    public final static Retweet Get(Key key){
        if (null != key){
            Retweet instance = (Retweet)gap.data.Store.Get(key);
            if (null != instance)
                return instance;
    ...
    public final static Retweet FromObject(Object value){
        if (null == value)
            return null;
        else if (value instanceof Retweet)
     ...
     * memcache and store.
     */
    public final static void Delete(Retweet instance){
        if (null != instance){
     ...
     */
    public final static void Clean(Retweet instance){
        if (null != instance){
            Key key = instance.getKey();
     ...
     * Store the instance.
     */
    public final static void Save(Retweet instance){
        if (null != instance){
     ...
     */
    public final static void Store(Retweet instance){
        if (null != instance){
            gap.data.Store.Put(instance);
        }
    }
    ...
    public final static Retweet Query1(Query query){
        if (null != query)
            return (Retweet)gap.data.Store.Query1(query);
        else
            throw new IllegalArgumentException();
    }
    ...
    /**
     * Persistent fields' binding for {@link Retweet}
     */
        ...
        implements gap.data.Field<Field>
    {
        ...
        public static Object Get(Field field, Retweet instance, boolean mayInherit){
            switch(field){
            case InheritFromKey:
            ...
            default:
                throw new IllegalArgumentException(field.toString()+" in Retweet");
            }
        }
        public static boolean Set(Field field, Retweet instance, Object value){
            switch(field){
            case InheritFromKey:
    ...
    private volatile transient Retweet inheritFrom;
    ...
    public final Retweet getInheritFrom(){
        Retweet inheritFrom = this.inheritFrom;
        if (null == inheritFrom){
            Key inheritFromKey = this.inheritFromKey;
            if (null != inheritFromKey){
                inheritFrom = Retweet.Get(inheritFromKey);
                this.inheritFrom = inheritFrom;
            }
        }
        return inheritFrom;
    }
    public final boolean setInheritFrom(Retweet ancestor){
    ...
    public final boolean inheritFrom(Retweet ancestor){
        if (IsNotEqual(this.inheritFrom,ancestor)){
            this.inheritFrom = ancestor;
            if (null != ancestor)
                this.inheritFromKey = ancestor.getKey();
    ...
    public final boolean updateFrom(BigTable proto){
        return this.updateFrom( (Retweet)proto);
    }
    public final boolean updateFrom(Retweet proto){
    ...
    public void setVariable(TemplateName name, String value){
        ...
        if (null != field){
            if (name.has(1)){
                ...
                Field.Set(field,((Retweet)this),value);
        }
        else {
