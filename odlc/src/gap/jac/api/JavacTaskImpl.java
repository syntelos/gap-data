...
import gap.jac.source.util.*;
import gap.jac.code.*;
import gap.jac.code.Symbol.*;
import gap.jac.comp.*;
import gap.jac.file.JavacFileManager;
import gap.jac.*;
import gap.jac.model.*;
import gap.jac.parser.Parser;
import gap.jac.parser.Scanner;
import gap.jac.tree.*;
...
public class JavacTaskImpl extends JavacTask {
    ...
    private void prepareCompiler() throws IOException {
        if (!used.getAndSet(true)) {
            ...
            gap.jac.parser.DocCommentScanner.Factory.preRegister(context);
