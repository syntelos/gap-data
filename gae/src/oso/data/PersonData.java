 ...
 * @see Person
 */
@Generated(value={"gap.service.OD","BeanData.java"},date="2012-07-04T02:25:03.184Z")
    ...
    implements DataInheritance<Person>
{
        ...
        implements gap.data.Field<Person.Field>
    {
        ...
        Blessed("blessed",Type.Primitive);
        ...
        public static Object Get(Field field, Person instance, boolean mayInherit){
            ...
            case Blessed:
                return instance.getBlessed(mayInherit);
            default:
        ...
        public static boolean Set(Field field, Person instance, Object value){
            ...
            case Blessed:
                return instance.setBlessed(gap.Objects.BooleanFromObject(value));
            default:
                throw new IllegalArgumentException(field.toString()+" in Person");
            }
        }
        ...
        public static java.io.Serializable Storage(Field field, Person instance){
            ...
            case Blessed:
                return instance.getBlessed(MayNotInherit);
            default:
                throw new IllegalArgumentException(field.toString()+" in Person");
            }
        }
        ...
        public static void Storage(Field field, Person instance, java.io.Serializable value){
            ...
            case LogonId:
                ...
                return;
            case Blessed:
                instance.setBlessed( (Boolean)value);
                return;
            default:
                throw new IllegalArgumentException(field.toString()+" in Person");
            }
    ...
    public final boolean hasBlessed(boolean mayInherit){
        return (null != this.getBlessed(mayInherit));
    }
    public final boolean hasNotBlessed(boolean mayInherit){
        return (null == this.getBlessed(mayInherit));
    }
    public final boolean dropBlessed(){
        if (null != this.blessed){
            this.fieldStatistics().markDirty(Person.Field.Blessed);
            this.blessed = null;
            return true;
        }
        else
    ...
    public final Boolean getBlessed(){
        return this.getBlessed(Notation.MayInherit);
    }
    public final Boolean getBlessed(boolean mayInherit){
        if (mayInherit){
            Boolean blessed = this.blessed;
            if (null == blessed && this.hasInheritFrom()){
                Person inheritFrom = this.getInheritFrom();
                return inheritFrom.getBlessed(Notation.MayInherit);
            }
            return blessed;
        }
        else
    ...
    public final boolean setBlessed(Boolean blessed, boolean withInheritance){
        if (IsNotEqual(this.blessed,this.getBlessed(withInheritance))){
            this.fieldStatistics().markDirty(Person.Field.Blessed);
    ...
    public final boolean setBlessed(Boolean blessed){
        if (IsNotEqual(this.blessed,blessed)){
            this.fieldStatistics().markDirty(Person.Field.Blessed);
            this.blessed = blessed;
            return true;
        }
    ...
    public Json toJsonBlessed(){
        Boolean blessed = this.getBlessed();
        return Json.Wrap( blessed);
    }
    public boolean fromJsonBlessed(Json json){
        if (null == json)
            return false;
        else 
            return this.setBlessed((Boolean)json.getValue(Boolean.class));
    }
    /*
    ...
    public Json toJson(){
        ...
        Json blessed = this.toJsonBlessed();
        if (null != blessed)
            json.set("blessed",blessed);
        return json;
    }
    public boolean fromJson(Json json){
        boolean modified = false;
        modified = (this.fromJsonBlessed(json.at("blessed")) || modified);
        return modified;
    }
    public boolean updateFrom(Request req) throws ValidationError {
        boolean change = false;
        String blessedRequest = req.getParameter("blessed");
        if (null != blessedRequest && 0 < blessedRequest.length()){
            try {
                Boolean blessed = gap.Strings.BooleanFromString(blessedRequest);
                if (this.setBlessed(blessed)){
                    change = true;
                }
            }
            catch (RuntimeException exc){
                throw new ValidationError(ClassName,"blessed",blessedRequest,exc);
            }
        }
        return change;
    }
    ...
    public final boolean updateFrom(Person proto){
        ...
        boolean change = false;
        Boolean blessed = proto.getBlessed(mayInherit);
        if (null != blessed && this.setBlessed(blessed)){
            change = true;
        }
        return change;
    }
    ...
    public final Person markDirty(java.io.Serializable instance){
        ...
        else if (instance == this.blessed){
            gap.data.Field field = Person.Field.Blessed;
            return this.markDirty(field);
        }
        ...
        if (null != field){
            ...
            case Blessed:
                if (name.has(1))
                     ...
                     */
                    return (this.hasBlessed(true) && this.getBlessed(true));
                }
            default:
                break;
            }
        ...
        if (null != field){
            ...
            case Blessed:
                if (name.has(1))
                    ...
                    return gap.Strings.BooleanToString(this.getBlessed(true));
            default:
                break;
            }
        }
